<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Ilyass-Hakim/Ilyass-Hakim/main/assets/header-dark.svg?v=4">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Ilyass-Hakim/Ilyass-Hakim/main/assets/header-light.svg?v=4">
    <img alt="Ilyass Hakim — I build software end to end, and the pipelines that ship it." src="https://raw.githubusercontent.com/Ilyass-Hakim/Ilyass-Hakim/main/assets/header-dark.svg?v=4" width="100%">
  </picture>
</p>
...
|---|---|---|
| **[first-demo-project](https://github.com/Ilyass-Hakim/first-demo-project)** | A 13-stage DevSecOps pipeline: build → Tomcat → Gitleaks → SonarQube → Semgrep → OWASP → Artifactory → Docker Hub → Kubernetes via Ansible → DefectDojo | Jenkins, Ansible, Kubernetes, Docker, SonarQube, Semgrep, Gitleaks, OWASP DC, DefectDojo, Artifactory |
| **[sensai-backend](https://github.com/Ilyass-Hakim/sensai-backend)** · **[sensai-android](https://github.com/Ilyass-Hakim/-sensai-android)** | Learning platform: 41-class Spring Boot service with 9 Flyway migrations, WebSocket chat, JWT auth and rate limiting, backed by a local LLM — plus a Compose Android client | Spring Boot, PostgreSQL, Redis, Ollama, WebSocket, Flyway, Bucket4j, Jetpack Compose, Hilt, Retrofit |
| **[charity](https://github.com/Ilyass-Hakim/charity)** | CharityHub — donation platform with campaign management, payments and four-language i18n, on a dual PostgreSQL + MongoDB store | Java 21, Spring Boot 3, Spring Security, PostgreSQL, MongoDB, Stripe, Google OAuth, Cloudinary, Thymeleaf, Docker Compose |
| **[ASP-DotNet-Project](https://github.com/Ilyass-Hakim/ASP-DotNet-Project)** | CollabRH — HR platform for leave, telework and documents, with four role-based dashboards and real-time notifications | ASP.NET Core 9, EF Core, ASP.NET Identity, SignalR, SQL Server, Chart.js |
| **[Emsi-react-native-project](https://github.com/Ilyass-Hakim/Emsi-react-native-project)** | Incident reporting app — photo capture, full triage workflow, live sync | React Native, Expo, Firebase Firestore, Supabase, Zustand |
